...
- 153146a: Move the React provider/hook exports to a dedicated `./react` entry so the package root is framework-neutral.
...
- b09752b: Add a retry seam, a typed error, and an optional logger to surface failures the fetcher previously swallowed.
